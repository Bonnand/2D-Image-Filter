...
##ref mig page 27
create_generated_clock -name pxl_clk_O [get_pins Inst_DataFlow_Display/Inst_VGA/Inst_PxlClkGen/mmcm_adv_inst/CLKOUT0]
##set_clock_groups -asynchronous -group [get_clocks -of_objects [get_pins Inst_DataFlow_Display/Inst_VGA/Inst_PxlClkGen/mmcm_adv_inst/CLKOUT0]] -group [get_clocks clk_i]
##create_generated_clock -name pxl_clk_O [get_pins Inst_DataFlow_Display/Inst_VGA/Inst_PxlClkGen/mmcm_adv_inst/CLKOUT0]
##create_clock -add -name CLK_OUT1 -period 9.00 -waveform {0 4.5} [get_pins "Inst_DataFlow_Display/Inst_VGA/pxl_clk_O"]

##Switches

set_property -dict {PACKAGE_PIN J15 IOSTANDARD LVCMOS33} [get_ports ISEcho]
set_property -dict {PACKAGE_PIN L16 IOSTANDARD LVCMOS33} [get_ports ISRealFreq]
#set_property -dict {PACKAGE_PIN L16 IOSTANDARD LVCMOS33} [get_ports rst_i]

set_property -dict {PACKAGE_PIN M13 IOSTANDARD LVCMOS33} [get_ports ISPureFreq]
set_property -dict {PACKAGE_PIN R15 IOSTANDARD LVCMOS33} [get_ports ISFIFO]
set_property -dict {PACKAGE_PIN R17 IOSTANDARD LVCMOS33} [get_ports ISFast]
set_property -dict {PACKAGE_PIN T18 IOSTANDARD LVCMOS33} [get_ports ISSlow]
#set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports { SW[6] }]; #IO_L17N_T2_A13_D29_14 Sch=sw[6]
set_property -dict {PACKAGE_PIN R13 IOSTANDARD LVCMOS33} [get_ports ISVolUp]
set_property -dict {PACKAGE_PIN T8 IOSTANDARD LVCMOS18} [get_ports ISVolDown]
set_property -dict {PACKAGE_PIN U8 IOSTANDARD LVCMOS18} [get_ports ISSiren]
set_property -dict {PACKAGE_PIN R16 IOSTANDARD LVCMOS33} [get_ports ISMusic]
